...
import 'package:untitled/operations_screen.dart';
import 'package:untitled/payment_voucher_screen.dart';
import 'package:untitled/receipt_voucher_screen.dart';
        ...
        GridView.count(
          ...
          children: [
            ...
            _buildQuickActionCard(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (_) => const PaymentVoucherScreen()),
                );
              },
            ),
            _buildQuickActionCard(
