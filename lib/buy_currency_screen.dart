  ...
  Future<void> _saveTransaction() async {
    if (_formKey.currentState!.validate()) {
      ...
      await _transactionService.createCurrencyExchangeTransaction(
        ...
        debitAccountId: _selectedDebitAccount!, // حساب العملة المشتراة (المدين)
        creditAccountId: _selectedCreditAccount!, // حساب العملة المدفوعة (الدائن)
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('تم حفظ عملية الشراء بنجاح'),
