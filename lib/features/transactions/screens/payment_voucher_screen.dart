...
class PaymentVoucherScreen extends StatefulWidget {
  ...
  const PaymentVoucherScreen({super.key, this.transactionId});
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  Text(
                    _editingTransactionId != null ? 'تعديل سند صرف' : 'إضافة سند صرف',
                    ...
                    builder: (context, snapshot) {
                        ...
                        return Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              Text(
                                'انقر على زر + لإضافة سند صرف جديد',
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          // For Payment: creditAccount is the fund, debitAccount is the destination
                          final fundAccount = creditName; // Fund is credit in payment
                          final otherAccount = debitName;
