...
class BuyCurrencyScreen extends StatefulWidget {
  ...
  const BuyCurrencyScreen({super.key, this.transactionId});
...
class _BuyCurrencyScreenState extends State<BuyCurrencyScreen> {
  ...
  String? _selectedDebitAccount; // حساب العملة المشتراة (المدين)
  String? _selectedCreditAccount; // حساب العملة المدفوعة (الدائن)
      ...
      if (_editingTransactionId != null) {
        ...
        if (mounted) {
          ...
          showMessageDialog(
            context,
            title: 'نجح الحفظ',
            message: 'تم حفظ عملية الشراء بنجاح',
            type: MessageType.success,
          );
        }
      }
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        _editingTransactionId != null ? 'تعديل عملية شراء عملة' : 'إضافة عملية شراء عملة',
                    ...
                    child: Column(
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          decoration: AppTheme.inputDecoration(
                            'الحساب المدين (حساب العملة المشتراة)',
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          decoration: AppTheme.inputDecoration(
                            'الحساب الدائن (حساب العملة المدفوعة)',
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<List<ts.Transaction>>(
              stream: _transactionService.streamTransactionsByType('BuyCurrency'),
                  ...
                  return Center(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.trending_down, size: 64, color: Colors.grey.shade400),
                          const SizedBox(height: 16),
                          Text(
                            'لا توجد عمليات شراء لعرضها',
